...
const AddToCart = ({ cart, item }: {cart?: Cart, item: CartItem}) => {
    ...
    return existItem ? (
        ...
        <Button className="w-full" type="button" onClick={handleAddToCart}>{ isPending ? (<Loader className='w-4 h-4 animate-spin' />) : (<Minus className="h-4 w-4"/>)}Add To Cart</Button>
    );
}
