        ...
        <form action={action}>
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <Input id='confirPassword' name='confirPassword' type='confirPassword' required autoComplete='confirPassword' defaultValue={signUpDefaultValues.password}/>
                </div>
                <div>
                    <SignUpButton />
                </div>
                ...
                <div className="text-sm text-center tex muted-foreground">
